...
path3,table_2003_2020_correspondances_bis, url3 = a.download_table(includeUnmodified_value='true',filepath='./correspondances_test.csv',table = 'Correspondances',startPeriod_value = '2003',endPeriod_value = '2020', str_format_start = '%Y', str_format_end = '%Y')
